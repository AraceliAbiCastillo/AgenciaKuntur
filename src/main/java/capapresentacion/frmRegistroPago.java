 ...
 * @author uSUARIO
 */
public class frmRegistroPago extends javax.swing.JFrame {

    /**
     * Creates new form frmRegistroPago
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRegistroPago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmRegistroPago().setVisible(true);
            }
        });
    }
