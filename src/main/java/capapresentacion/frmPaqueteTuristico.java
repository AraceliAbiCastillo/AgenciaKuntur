...
import capanegocio.PaqueteTuristico;

/**
 *
 * @author uSUARIO
 */
public class frmPaqueteTuristico extends javax.swing.JFrame {

    /**
     * Creates new form frmRegistroVenta
     */
    public frmPaqueteTuristico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(156, 174, 192));
        ...
        lblFechaIda.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblFechaIda.setText("Ida:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPaqueteTuristico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPaqueteTuristico().setVisible(true);
            }
        });
    }
